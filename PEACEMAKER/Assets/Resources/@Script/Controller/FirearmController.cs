    ...
    public class FirearmController : MonoBehaviour
    {
       ...
       -------------------------*/
        ...
        private void Awake()
        {
            ...
            defaultDecalPrefab = UnityEngine.Resources.Load<GameObject>("@Prefabs/Particle Systems/Bullet Impact/Stone Impact.prefab");
        ...
        private void FireInternal(Vector3 firePosition, Quaternion fireRotation, Vector3 fireDirection)
        {
            ...
            if (IsPlayingRestrictedAnimation() == false)
            {
                ...
                //SFX 적용
                //PlaySound
                SystemManager.Audio.PlaySFX(fireSound, 1f, 0,false);
            }
        ...
        public ProjectileController SpawnProjectile(Vector3 position, Quaternion rotation, Vector3 direction, float speed, float range)
        {
            ...
            if (projectilePrefab == null)
            {
                ...
                projectilePrefab = UnityEngine.Resources.Load<ProjectileController>("@Prefabs/Weapons/Projectile");
                return null;
            }
